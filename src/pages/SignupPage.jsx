  ...
  return (
    <div className="min-h-screen flex">
      <motion.div
        ...
        className="w-full lg:w-1/2 flex flex-col min-h-screen bg-white relative overflow-y-auto order-2 lg:order-1"
      >
        <div className="absolute top-0 left-0 w-96 h-96 bg-ghibli-sunset/10 rounded-full blur-3xl -z-0" />
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-ghibli-forest/10 rounded-full blur-3xl -z-0" />
